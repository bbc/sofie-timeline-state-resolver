...
## [9.1.0-release51.0](https://github.com/bbc/sofie-timeline-state-resolver/compare/9.0.0-release50.5...9.1.0-release51.0) (2023-08-25)


### Features

* BBC GSAAS Support ([828fe2d](https://github.com/bbc/sofie-timeline-state-resolver/commit/828fe2d4e6df04c9ff1daeeb42e05e2ad2084955))
* **httpSend:** Proxy support ([6dc4c59](https://github.com/bbc/sofie-timeline-state-resolver/commit/6dc4c59424242b1ea6681c27c0647a9afaae7c17))
* **sisyfos:** Send fadeTime with faderLevel if specified ([5fa0446](https://github.com/bbc/sofie-timeline-state-resolver/commit/5fa0446a2b35e13e0ca293628022eeed925eb79a))


### Bug Fixes

* 'connectionChanged' event typings ([dcd9f02](https://github.com/bbc/sofie-timeline-state-resolver/commit/dcd9f026258ddebcc5f3303a691910308f940da7))
* add missing cleanup to osc and multi-osc ([71d1d8f](https://github.com/bbc/sofie-timeline-state-resolver/commit/71d1d8fb991abf5cfad691768b6acca66231b6c0))
* ensure new services are added to `DevicesDict` ([0067869](https://github.com/bbc/sofie-timeline-state-resolver/commit/0067869a31b4d0c3a0afb8d0b647b655ed6a2fd3))
* **httpSend:** Use the same types for the sendCommand action as a timeline object ([#269](https://github.com/bbc/sofie-timeline-state-resolver/issues/269)) ([3385217](https://github.com/bbc/sofie-timeline-state-resolver/commit/3385217afcb6e45aa37123f5400d1dea4a0c8972))
* missing httpsend enums ([920da05](https://github.com/bbc/sofie-timeline-state-resolver/commit/920da0506cd9f2142d0edabfd9894ccd88d288cf))
